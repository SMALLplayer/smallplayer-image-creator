...
class DateHelper:
    ...
    @staticmethod
    def GetDateForNextDay(day, possibilities = ["ma", "di", "wo", "do", "vr", "za", "zo"], tomorrow = "Morgen"):
    ...
    @staticmethod
    def GetDateForPreviousDay(day, possibilities = ["ma", "di", "wo", "do", "vr", "za", "zo"], yesterday = "Gisteren"):
